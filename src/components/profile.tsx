                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-3 mt-3">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-foreground">☁️ Cloud Sync & Auto Backup</p>
                            <p className="text-xs text-muted-foreground">Save expenses & trips online, access from any device with automatic backup and conflict resolution</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-foreground">✈️ Trip Management & Bill Splitting</p>
                            <p className="text-xs text-muted-foreground">Plan trips with friends, track expenses, and automatically split costs between everyone</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-3 mt-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground">☁️ Cloud Sync & Auto Backup</p>
                      <p className="text-xs text-muted-foreground">Your data syncs automatically across all devices with automatic backup and conflict resolution</p>
                    </div>
                  </div>
